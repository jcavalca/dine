/*this files has printing, parsing and exiting functions*/
...
sem_t mutex;	/*for changing states 
				 and printing atomically*/
...
/*checks for optional command line input*/
...
/*prints initial state, all philosophers 
  start thinking*/
...
/*prints current state for all philosophers*/
void print_states(){
...
/*only used for failed sys calls*/
